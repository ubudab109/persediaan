...
class BarangMasukController extends Controller
{
    ...
    public function __construct(BarangMasuk $model, DetailBarangMasuk $detail)
    {
        $this->model = $model;
        $this->detail = $detail;
    }
        ...
        if($request->ajax()) {
            return DataTables::of($data)
                             ...
                             ->addColumn('action', function($row){
                                 $action = '<a href="'.route('barang-masuk.show',['id' => $row->id]).'" class="delete btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
    ...
    public function getBarangMasukDetail(Request $request, $id)
    {
        $data = $this->detail->where('id_barang_masuk', $id)->with('barang.satuan:id,nama')->get();
    ...
    public function create()
    {
        ...
        return view('pages.barang-masuk.create')->with(['barang' => $barang]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->all();
            $barangMasuk = $this->model->create($input);
            foreach($request->barang as $key => $value) {
                ...
                $barangMasuk->detail()->create($inputDataBarang);
            }
    ...
    public function show($id)
    {
        ...
        return view ('pages.barang-masuk.show')->with(['data' => $data]);
    }

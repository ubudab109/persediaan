...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-xl-6 col-lg-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Input Detail Pengeluaran Barang</h6>
      </div>
      <div class="card-body">
        <form method="POST" action="{{route('barang-keluar.store')}}">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="inputPassword4">Tanggal Pengeluaran</label>
              <input type="date" name="tanggal_keluar" class="form-control" id="inputPassword4" required>
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="inputAddress">Picker</label>
            <input type="text" class="form-control" name="picker" id="inputAddress" placeholder="Picker..." required>
          </div>
          <div class="form-group">

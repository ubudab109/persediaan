...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <form action="{{ route('barang-keluar.update-barang', ['id' => $data->id]) }}" method="POST">
      @csrf
  ...
  <div class="col-xl-6 col-lg-4">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <hr />
        <div class="row">
          <div class="col-4">Picker </div>
          <div class="col-4">: {{$data->picker}}</div>
        </div>
        <hr />
        <div class="row">
          <div class="col-4">Tanggal Transaksi </div>
          <div class="col-4">: {{$data->tanggal_keluar}}</div>
        </div>
        <hr />
        <div class="row">
        ...
        <div class="text-center">
          <a class="btn btn-primary" href="{{route('barang-keluar.index')}}" type="button">Kembali</a>
        </div>
      </div>
  </div>
</div>
...
@section('scripts')
  <script type="text/javascript">
    ...
    var url = '{{ route("data.detail-barang-keluar", ":id") }}';
